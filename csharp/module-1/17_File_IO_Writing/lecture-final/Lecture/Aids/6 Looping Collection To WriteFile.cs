    ...
    public static class LoopingCollectionToWriteFile
    {
        ...
        */
        public static void LoopingADictionaryToWriteAFile()
        {
            ...
            string directory = Environment.CurrentDirectory; //remember, this is the current directory where the program is running, not where the files we see in VS live
