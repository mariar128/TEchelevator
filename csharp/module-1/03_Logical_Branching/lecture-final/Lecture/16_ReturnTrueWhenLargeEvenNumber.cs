namespace Lecture
{
    public partial class LectureExample
    {
        ...
        */
        ...
        {
            if (number % 2 == 0 && number > 100 && number % 5 == 0) //number divided by two has zero remainder if even, and number is over 100, and number divided by five has zero remainder
            {
