...
namespace TechElevator.Exercises.LogicalBranching
{
    ...
    public class PackageAcceptance
    {
        ...
        {
            int cubicSize = lengthInInches * widthInInches * heightInInches;

            return weightInPounds <= MaxWeightPounds && cubicSize <= MaxCubicInches;
        }
        ...
        {
            int cubicSize = lengthInInches * widthInInches * heightInInches;
            bool violatesDimensions = lengthInInches > MaxDimensionInches || 
                                      widthInInches > MaxDimensionInches || 
                                      heightInInches > MaxDimensionInches;

            return weightInPounds <= MaxWeightPounds && cubicSize <= MaxCubicInches && (!violatesDimensions || isSurchargePaid);
        }
    }
}
