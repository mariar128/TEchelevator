...
{
    if(gpa > 4.0 || satScore > 1300 || gpa > 3.0 && recommendation != null || satScore > 1200 && recommendation != null)
    {
        return true;
    }
    return false;
...
let numbers = unfilteredArray.filter(filterFunction)
...
return number = Number(firstAndSecond);
}
