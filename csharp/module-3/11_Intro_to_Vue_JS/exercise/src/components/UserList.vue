    ...
    filteredList() {
      let filtered = this.users.filter((user) => {
        return (
          user.firstName
            .toUpperCase()
            .includes(this.search.firstName.toUpperCase()) &&
          user.lastName
            .toUpperCase()
            .includes(this.search.lastName.toUpperCase()) &&
          user.username
            .toUpperCase()
            .includes(this.search.username.toUpperCase()) &&
          user.emailAddress
            .toUpperCase()
            .includes(this.search.emailAddress.toUpperCase()) &&
