...
document.addEventListener('DOMContentLoaded', (event) => {
 ...
 // set the variable called display declared at the top of this file equal to the display element
  ...
  const calcButtonArray = document.querySelectorAll('.number');
  calcButtonArray.forEach((calcButton) => {
      calcButton.addEventListener('click', clickNumber)
  });
...
const clearButtonArray = document.querySelector('.all-clear')
clearButtonArray.addEventListener('click',clear);
...
const operatorButtonElement = document.querySelectorAll('.operator');
operatorButtonElement.forEach((operatorButton) => {
...
const equalOperator = document.querySelector('.equal-sign');
