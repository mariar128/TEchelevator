<template>
  <div class="main">
    ...
    <button id="showButton" v-on:click="showForm = true" v-show="showForm === false">Show Form</button>
    <!-- <button id="ifButton" v-on:click="showForm = true" v-if="showForm === false">Show Form</button> -->
