...
namespace USCitiesAndParks.Tests
{
    ...
    public class ParkSqlDaoTests : BaseDaoTests
    {
        ...
        {
            //let's try getting park 2 from the test db 
        ...
        {
            Park parkToUpdate = dao.GetPark(2); //the least amount of code I can write to get a park #lazy
