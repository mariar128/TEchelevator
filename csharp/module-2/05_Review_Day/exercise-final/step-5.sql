...
/* OR WITH SUBQUERIES: 
INSERT INTO reservation (site_id, name, from_date, to_date) VALUES ((SELECT site_id FROM site WHERE site_number = 623), 'Wayne Family', GETDATE() + 10, GETDATE() + 20);
INSERT INTO reservation (site_id, name, from_date, to_date) VALUES ((SELECT site_id FROM site WHERE site_number = 624), 'Parker Family', GETDATE() + 11, GETDATE() + 20);
INSERT INTO reservation (site_id, name, from_date, to_date) VALUES ((SELECT site_id FROM site WHERE site_number = 625), 'Kent Family', GETDATE() + 12, GETDATE() + 20);
*/
